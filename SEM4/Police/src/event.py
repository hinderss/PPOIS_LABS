...
class Crime(Event):
    def __init__(self, title: str, description: str, slots: int, difficulty: str, m_investigation_time, law: Law):
        super().__init__(title, description, slots)
        self.difficulty = difficulty
        # self.min_investigation_time = m_investigation_time
        self.law = law
...
class Call(Event):
    def __init__(self, title: str, description: str, slots: int, difficulty: str, address: str, reaction_time):
        super().__init__(title, description, slots)
        self.difficulty = difficulty
